...
public class Jogo {
	...
	public Jogo(long jogo_id, int rodada, VencedorJogo vencedor_jogo, long equipe_mandante_id, long equipe_visitante_id,
			long escalacao_mandante_id, long escalacao_visitante_id, boolean cancelado, boolean suspenso, boolean wo,
			boolean decisivo, String placar_penaltis_mandante, String placar_penaltis_visitante, long fase_id,
			Fase fase, EquipeVisitante equipe_visitante, EquipeMandante equipe_mandante, long sede_id, Sede sede,
			int placar_oficial_visitante, int placar_oficial_mandante, String hora_realizacao, String data_realizacao) {
		super();
	...
	public String toString() {
		return "Jogo [jogo_id=" + jogo_id + ", rodada=" + rodada + ", vencedor_jogo=" + vencedor_jogo
				+ ", equipe_mandante_id=" + equipe_mandante_id + ", equipe_visitante_id=" + equipe_visitante_id
				+ ", escalacao_mandante_id=" + escalacao_mandante_id + ", escalacao_visitante_id="
				+ escalacao_visitante_id + ", cancelado=" + cancelado + ", suspenso=" + suspenso + ", wo=" + wo
				+ ", decisivo=" + decisivo + ", placar_penaltis_mandante=" + placar_penaltis_mandante
				+ ", placar_penaltis_visitante=" + placar_penaltis_visitante + ", fase_id=" + fase_id + ", fase=" + fase
				+ ", equipe_visitante=" + equipe_visitante + ", equipe_mandante=" + equipe_mandante + ", sede_id="
				+ sede_id + ", sede=" + sede + ", placar_oficial_visitante=" + placar_oficial_visitante
				+ ", placar_oficial_mandante=" + placar_oficial_mandante + ", hora_realizacao=" + hora_realizacao
