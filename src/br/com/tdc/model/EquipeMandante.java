...
public class EquipeMandante {
	...
	public EquipeMandante(long equipe_id, String nome, String nome_popular, String sigla, String genero, Escudo escudos,
			Cor cores, String slug) {
		super();
	...
	public String toString() {
		return "EquipeMandante [equipe_id=" + equipe_id + ", nome=" + nome + ", nome_popular=" + nome_popular
