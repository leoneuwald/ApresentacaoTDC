...
public class Edicao {
	...
	public Edicao(long edicao_id, String nome, String slug, long campeonato_id, Campeonato campeonato,
			String slug_editorial) {
		super();
	...
	public String toString() {
		return "Edicao [edicao_id=" + edicao_id + ", nome=" + nome + ", slug=" + slug + ", campeonato_id="
				+ campeonato_id + ", campeonato=" + campeonato + ", slug_editorial=" + slug_editorial + "]";
	}
