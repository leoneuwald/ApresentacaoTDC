...
public class Fase {
	...
	public Fase(long fase_id, String nome, String data_inicio, String data_fim, boolean atual, long edicao_id,
			Edicao edicao, int ordem, Tipo tipo, Formato formato, String slug, String disclaimer) {
		super();
	...
	public String toString() {
		return "Fase [fase_id=" + fase_id + ", nome=" + nome + ", data_inicio=" + data_inicio + ", data_fim=" + data_fim
				+ ", atual=" + atual + ", edicao_id=" + edicao_id + ", edicao=" + edicao + ", ordem=" + ordem
				+ ", tipo=" + tipo + ", formato=" + formato + ", slug=" + slug + ", disclaimer=" + disclaimer + "]";
	}
