...
public class Equipe {
	...
	public Equipe(long equipe_id, String genero, String nome, Escudo escudos,
			String slug, Cor cor, String nome_popular, String sigla) {
		super();
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((nome_popular == null) ? 0 : nome_popular.hashCode());
	...
	public String toString() {
		return "Equipe [equipe_id=" + equipe_id + ", genero=" + genero
				+ ", nome=" + nome + ", escudos=" + escudos + ", slug=" + slug
				+ ", cor=" + cor + ", nome_popular=" + nome_popular
				+ ", sigla=" + sigla + "]";
	}
