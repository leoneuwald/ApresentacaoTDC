...
public class Classificacao {
	...
	public Classificacao(int variacao, int ordem, String equipe_url, int saldo_gols, int empates, int pontos,
			int derrotas, String variacao_label, Equipe equipe,
			List<AproveitamentoUltimosJogos> aproveitamento_ultimos_jogos, int vitorias) {
		super();
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((aproveitamento_ultimos_jogos == null) ? 0 : aproveitamento_ultimos_jogos.hashCode());
	...
	public String toString() {
		return "Classificacao [variacao=" + variacao + ", ordem=" + ordem + ", equipe_url=" + equipe_url
				+ ", saldo_gols=" + saldo_gols + ", empates=" + empates + ", pontos=" + pontos + ", derrotas="
				+ derrotas + ", variacao_label=" + variacao_label + ", equipe=" + equipe
				+ ", aproveitamento_ultimos_jogos=" + aproveitamento_ultimos_jogos + ", vitorias=" + vitorias + "]";
	}
