...
public class Partida {
	...
	public Partida(long id, long id_api, List<Gol> gols, String equipe_mandante_nome, String equipe_mandante_url_logo,
			...
			String equipe_visitante_nome, String equipe_visitante_url_logo, String equipe_visitante_sigla,
			int placar_visitante, int placar_penaltis_visitante, String tecnico_visitante, String campeonato_nome,
			int rodada_campeonato, String taca, String grupo, String fase, int temporada, String cidade,
			String nome_estadio, String data, String match_date, String arbitro, long publico, double renda,
			int num_jogo_chave, boolean tem_data_definida, boolean tem_hora_definida, boolean tem_estatistica,
			boolean tem_narracao, long equipe_mandante, long equipe_visitante, int campeonato, int fase_campeonato,
			int fase_ordem) {
		super();
		this.id = id;
		this.id_api = id_api;
	...
	public String toString() {
		return "Partida [id=" + id + ", id_api=" + id_api + ", gols=" + gols + ", equipe_mandante_nome="
				+ equipe_mandante_nome + ", equipe_mandante_url_logo=" + equipe_mandante_url_logo
				+ ", equipe_mandante_sigla=" + equipe_mandante_sigla + ", placar_mandante=" + placar_mandante
				+ ", placar_penaltis_mandante=" + placar_penaltis_mandante + ", tecnico_mandante=" + tecnico_mandante
				+ ", equipe_visitante_nome=" + equipe_visitante_nome + ", equipe_visitante_url_logo="
				+ equipe_visitante_url_logo + ", equipe_visitante_sigla=" + equipe_visitante_sigla
				+ ", placar_visitante=" + placar_visitante + ", placar_penaltis_visitante=" + placar_penaltis_visitante
				+ ", tecnico_visitante=" + tecnico_visitante + ", campeonato_nome=" + campeonato_nome
				+ ", rodada_campeonato=" + rodada_campeonato + ", taca=" + taca + ", grupo=" + grupo + ", fase=" + fase
				+ ", temporada=" + temporada + ", cidade=" + cidade + ", nome_estadio=" + nome_estadio + ", data="
				+ data + ", match_date=" + match_date + ", arbitro=" + arbitro + ", publico=" + publico + ", renda="
				+ renda + ", num_jogo_chave=" + num_jogo_chave + ", tem_data_definida=" + tem_data_definida
				+ ", tem_hora_definida=" + tem_hora_definida + ", tem_estatistica=" + tem_estatistica
				+ ", tem_narracao=" + tem_narracao + ", equipe_mandante=" + equipe_mandante + ", equipe_visitante="
				+ equipe_visitante + ", campeonato=" + campeonato + ", fase_campeonato=" + fase_campeonato
				+ ", fase_ordem=" + fase_ordem + "]";
	}
