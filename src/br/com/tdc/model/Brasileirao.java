...
public class Brasileirao {
	...
	public Brasileirao(String url, String nome_fase, Map<String, String> class_names, Edicao edicao,
			List<Classificacao> classificacao, Campeonato campeonato, String img_url, String css) {
		super();
		this.url = url;
	...
	public String toString() {
		return "Brasileirao [url=" + url + ", nome_fase=" + nome_fase + ", class_names=" + class_names + ", edicao="
				+ edicao + ", classificacao=" + classificacao + ", campeonato=" + campeonato + ", img_url=" + img_url
				+ ", css=" + css + "]";
	}
