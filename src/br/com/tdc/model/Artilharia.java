...
public class Artilharia {
	...
	public Artilharia(long id, long total_gols, long total_partidas, String jogador_nome, String jogador_posicao,
			String equipe_nome, String equipe_url_logo) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Artilharia [id=" + id + ", total_gols=" + total_gols + ", total_partidas=" + total_partidas
				+ ", jogador_nome=" + jogador_nome + ", jogador_posicao=" + jogador_posicao + ", equipe_nome="
				+ equipe_nome + ", equipe_url_logo=" + equipe_url_logo + "]";
	}
