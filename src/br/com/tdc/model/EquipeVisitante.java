...
public class EquipeVisitante {
	...
	public EquipeVisitante(long equipe_id, String nome, String nome_popular, String sigla, String genero,
			Escudo escudos, Cor cores, String slug) {
		super();
	...
	public String toString() {
		return "EquipeVisitante [equipe_id=" + equipe_id + ", nome=" + nome + ", nome_popular=" + nome_popular
				+ ", sigla=" + sigla + ", genero=" + genero + ", escudos=" + escudos + ", cores=" + cores + ", slug="
				+ slug + "]";
	}
